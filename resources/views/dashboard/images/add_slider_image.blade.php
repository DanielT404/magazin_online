...
@section('content')
    <div class="container">
        ...
        @else
        <form action="{{route('slider_image.add.submit')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                <label for="active" class="col-md-4 control-label">Imagine activa (apare in slider)?</label>
