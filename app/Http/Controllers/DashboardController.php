...

{
    ...
    public function showAllBrandImages()

    {

        $brands = BrandImage::all();

        return view('dashboard.images.brand_images', ['images' => $brands]);
    ...
    public function add_brand_image(Request $request)

    {
        ...
        if($request->has('submitted')) {
            ...
            if($request->hasFile('image') && $request->file('image')->isValid()) {
               ...
               BrandImage::create(['image_path' => $request->file('image')->store('brand_image', 'public'), 'active' => $request->input('activeradio')]);

                return view('dashboard.images.add_brand_image')->with('success', true);
        ...
        return view('dashboard.images.add_brand_image');
